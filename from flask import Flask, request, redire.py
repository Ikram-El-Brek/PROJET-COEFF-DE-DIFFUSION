...
def home():
    return """
        <html>
            <body>
                <h1>Salut, je suis El brek ikram</h1>
                <p>Je suis étudiante en PIC12.</p>
...
def page3():
    try:
        ...
        # Liste des facteurs de correction à tester
        correction_factors = [1.0160, 1.0165, 1.0170, 1.0155, 1.0150]
        
        best_error = float('inf')
        best_factor = None
        best_D_AB = None
        
        # Tester chaque facteur de correction et choisir celui qui minimise l'erreur
        ...
        return f"""
            <html>
                <body>
                    ...
                    <p>Le coefficient de diffusion D_AB avec un facteur de correction de {best_factor} est : {best_D_AB:.6e} cm²/s</p>
                    <p>L'erreur relative par rapport à la valeur expérimentale est : {best_error:.2f} %</p>
